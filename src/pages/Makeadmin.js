...
import MakeadminTable from "../components/makeadmin/MakeadminTable";

const Makeadmin = () => {
  const { toggleDrawer } = useContext(SidebarContext);
  const { data, loading } = useAsyncCalender(CalenderServices.getAllBook);
  const {
    categoryRef,
    handleChangePage,
    totalResults,
  ...
  return (
    <>
      <PageTitle>एडमिन बनवा</PageTitle>
      ...
      {loading ? (
        ...
        <TableContainer className="mb-8">
          <Table>
            ...
            <MakeadminTable books={dataTable} />
          </Table>
          <TableFooter>
            <Pagination
