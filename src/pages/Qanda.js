...
import QandaTable from "../components/qanda/QandaTable";

const Qanda = () => {
  const { toggleDrawer } = useContext(SidebarContext);
  const { data, loading } = useAsyncCalender(CalenderServices.getQuestions);
  const {
    categoryRef,
    handleChangePage,
    totalResults,
  ...
  return (
    <>
      <PageTitle>प्रश्न उत्तर</PageTitle>
